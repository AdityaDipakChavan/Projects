...
class main_loop:
    ...
    def __init__(self):
        # serialport='/dev/ttyACM1',x_arm_adj=0,y_arm_adj=0):
    ...
    def capturefromPiCamera(self, imgdir,prefix="Cap",fullscreen=False,detectXYZ=True, calcXYZ=True):
            ...
            camera = PiCamera()                   #cv2.VideoCapture(0)
