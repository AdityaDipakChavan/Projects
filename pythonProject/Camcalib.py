# Importing the libraries required for the program
import numpy as np
import cv2 as cv
import glob
...
img = cv.imread(r"C:\Users\adity\PycharmProjects\pythonProject\500.png")
...
x, y, w, h = roi
dst = dst[y:y+h, x:x+w]
cv.imwrite('calibresulttrailCV.jpg', dst)
